...
function Kids(props: KidsProps) {
    const wsonicpi = find({id: 'kids_sonicpi'}, props.workshops);
    const wscratch = find({id: 'kids_scratch'}, props.workshops);
    const wappinventor = find({id: 'kids_appinventor'}, props.workshops);
    return (
