...
function Tickets(props: TicketsProps) {
    return (
            <Page name='tickets'>
        <Heading>
            <LargeHeading>Tickets to JavaZone 2018</LargeHeading>
            <SmallHeading>Come join us in Oslo, September 12-13th</SmallHeading>
        </Heading>
        <Container>

            <CBlock fullWidth={true} className='partners__price-container'>
                <CHeader><span className='pink'>Get your tickets for JavaZone 2018</span></CHeader>
                <CContent>
        ...
        <img className='partners__image' src={tickets3} />
