...
import { extendAll, join, map, filter, find, sortBy, includes, reduce, compose, get, curry } from 'lodash/fp';
...
function merge(workshops, sessions) {
    console.log(workshops, sessions);
